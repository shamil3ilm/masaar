    ...
    <div class="max-w-lg w-full mx-4">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-2">Select an organization to continue</p>
            </div>
            ...
            {{-- Only organizations the signed-in user is an active member of. --}}
            ...
            <form method="GET" action="{{ route('portal.dashboard') }}">
                <div class="space-y-3 mb-6">
                    ...
                    <label class="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                        <input type="radio" name="org_id" value="{{ $org->id }}" class="mr-4 text-blue-600" required>
            ...
            <div class="text-center py-8">
                ...
                <p class="text-sm text-gray-400 mt-2">Your account is not an active member of any organization. Contact your administrator.</p>
            </div>
            @endif
