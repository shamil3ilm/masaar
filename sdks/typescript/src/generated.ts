...
export const operations = {
  ...
  'adminDashboardController.environmentVariances': { method: 'get', path: '/api/admin/dashboard/variances', security: ['bearerAuth'], scopes: [], deprecated: false },
  ...
  'varianceController.index': { method: 'get', path: '/api/compliance/variances', security: ['bearerAuth'], scopes: [], deprecated: false },
  'varianceController.statistics': { method: 'get', path: '/api/compliance/variances/statistics', security: ['bearerAuth'], scopes: [], deprecated: false },
  'varianceController.show': { method: 'get', path: '/api/compliance/variances/{id}', security: ['bearerAuth'], scopes: [], deprecated: false },
  'varianceController.markReported': { method: 'post', path: '/api/compliance/variances/{id}/report', security: ['bearerAuth'], scopes: [], deprecated: false },
  'varianceController.resolve': { method: 'post', path: '/api/compliance/variances/{id}/resolve', security: ['bearerAuth'], scopes: [], deprecated: false },
  ...
  'v1.varianceController.index': { method: 'get', path: '/api/v1/variances', security: ['apiKey'], scopes: ['compliance.status'], deprecated: false },
  'v1.varianceController.statistics': { method: 'get', path: '/api/v1/variances/statistics', security: ['apiKey'], scopes: ['compliance.status'], deprecated: false },
  'v1.varianceController.show': { method: 'get', path: '/api/v1/variances/{id}', security: ['apiKey'], scopes: ['compliance.status'], deprecated: false },
  'v1.varianceController.markReported': { method: 'post', path: '/api/v1/variances/{id}/report', security: ['apiKey'], scopes: ['compliance.status'], deprecated: false },
  'v1.varianceController.resolve': { method: 'post', path: '/api/v1/variances/{id}/resolve', security: ['apiKey'], scopes: ['compliance.status'], deprecated: false },
