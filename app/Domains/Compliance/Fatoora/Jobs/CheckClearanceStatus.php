...
use App\Domains\Compliance\Fatoora\Services\ClearanceStateManager;
...
class CheckClearanceStatus implements ShouldQueue
{
    ...
    public function __construct(
        ...
        $this->tries = (int) config('fatoora.clearance_state.check_job_tries', 3);
        $this->backoff = (int) config('fatoora.clearance_state.check_job_backoff', 60);
    }
