 ...
 */
class FatooraSdkService
{
    private const SDK_PATH = null; // Use config('fatoora.sdk_path') instead
    ...
    {
        $this->sdkPath = $sdkPath ?? config('fatoora.sdk_path', storage_path('app/zatca-sdk/Apps'));
