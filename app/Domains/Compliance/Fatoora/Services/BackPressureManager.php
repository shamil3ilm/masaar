...
class BackPressureManager
{
    ...
    {
        return (int) config('fatoora.back_pressure.tokens_per_second', 10);
    }
    ...
    {
        return (int) config('fatoora.back_pressure.bucket_size', 100);
    }
    ...
    {
        return (int) config('fatoora.back_pressure.min_tokens', 1);
    }
    ...
    {
        return (int) config('fatoora.back_pressure.burst_allowance', 50);
    }
     ...
     *
     * @throws FatooraException if rate limited
     */
