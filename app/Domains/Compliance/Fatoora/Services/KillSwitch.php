...
class KillSwitch
{
    ...
    {
        return (int) config('fatoora.kill_switch.cache_ttl_seconds', 3600);
    }
    ...
    {
        return (int) config('fatoora.kill_switch.max_duration_seconds', 14400);
    }
    ...
    {
        return (int) config('fatoora.kill_switch.alert_threshold_seconds', 1800);
    }
