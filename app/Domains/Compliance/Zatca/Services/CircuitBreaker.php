...
class CircuitBreaker
{
    ...
    public function __construct(
        ...
        $this->name = $name;
        $this->failureThreshold = $failureThreshold ?? ZatcaConfig::CIRCUIT_BREAKER_THRESHOLD;
        $this->timeout = $timeout ?? ZatcaConfig::CIRCUIT_BREAKER_TIMEOUT;
        $this->sampleSize = $sampleSize ?? ZatcaConfig::CIRCUIT_BREAKER_SAMPLE_SIZE;
    }
